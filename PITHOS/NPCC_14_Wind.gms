...
$INCLUDE    'NPCC_Input/0-Profiles/NPCC_Wonhourlyprof.txt'
/;

parameter
Wof_HP(R,H)        'Hourly wind offshore profile per techno-region in %'     /
$INCLUDE    'NPCC_Input/0-Profiles/NPCC_Wofhourlyprof.txt'
/;
...
$INCLUDE 'NPCC_Input/1-CapUB/NPCC_CapMaxStage_W.txt'
/;

Parameter W_CF(W,PO)  'Wind cost factor for each scenario'/
$INCLUDE 'NPCC_Input/3-ScenVal/NPCC_CF_W.txt'
/;
************************************************************
************************************************************
