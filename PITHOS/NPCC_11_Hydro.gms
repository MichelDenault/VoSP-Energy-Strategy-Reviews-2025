...
$ondelim
$include 'NPCC_Input/0-Profiles/DATA_NPCC_HYDRO.csv'
$offdelim
;
...
$INCLUDE 'NPCC_Input/0-Profiles/NPCC_Hydro_ON.txt'
/;
Parameter WAPROF_AT(H) /
$INCLUDE 'NPCC_Input/0-Profiles/NPCC_Hydro_AT.txt'
/;
Parameter WAPROF_NY(H) /
$INCLUDE 'NPCC_Input/0-Profiles/NPCC_Hydro_NY.txt'
/;
Parameter WAPROF_NE(H) /
$INCLUDE 'NPCC_Input/0-Profiles/NPCC_Hydro_NE.txt'
/;
